...
TokenizerList = [AutoTokenizer, T5PegasusTokenizer]

class Seq2SeqTrainer_Chinese(Trainer):
    def evaluate(
        self,
...
def main():
    ...
    if model_args.model_name == 't5-pegasus':
    ...
    if training_args.do_eval:
        ...
        output_prediction_file = os.path.join(training_args.output_dir, "generated_predictions_eval.txt")
        ...
        bleu_scores = compute_bleus(predictions, refference_summaries) 
        print("Eval Metric:")
        print(rouge_scores)
        print(bleu_scores)       
